...
# print(list('ABCD'))
# 第一种方式生成DataFrame
# test_1 = pd.DataFrame(np.random.rand(4, 4),index=list('ABCD'), columns=list('1234')) 
# print(test_1)
# 第二种方式生成
# test_2 = pd.DataFrame([[1, 2, 3, 4], [2, 3, 4, 5], [3, 4, 5, 6], [4, 5, 6, 7]],index=list('1234'), columns=list('ABCD'))  # 自己输入
# print(test_2)
# 第三种方式
